...
from django.forms import ModelForm, TextInput, Textarea, DateField, DateTimeField, DateInput
...
class AuthenticationForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "user_birthday": DateInput(format=['%d/%m/%YY']),        #('Дата рождения'),
            "user_registration": DateInput(format=['%d/%m/%YY']),    #('Дата регистрации'),
